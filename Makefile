...
src/render.o src/room.o src/title_screen.o src/utility.o src/world.o
...
LIBDIR = libs
LDFLAGS =
LIBS = -lPDCurses -lSDL -lSDLmain -lGL -lGLU -lglut -lz -lpspvfpu -lpsphprm -lpspsdk -lpspctrl -lpspumd -lpsprtc \
